...
Student Performance
The dashboard compares average scores across performance levels and engagement levels. This allows us to examine whether higher engagement is associated with higher academic scores.

Final Results
Student outcomes are divided into categories such as:
...
Regional Analysis
Student enrollment is compared across different regions to identify differences in student distribution.

Dropout Analysis
The project also examines the dropout rate and provides filters that can be used to investigate dropout-related patterns across different student characteristics and engagement levels.
